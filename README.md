...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/terragrunt-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/terragrunt-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install terragrunt
```
...
It is possible to list all of the versions of `terragrunt` available on your platform:
...
```
pixi search terragrunt --channel conda-forge
```
